...
@click.option("-f", "--files", flag_value=True, help="Log the files found in the file system", default=False)
@cli.command(name="build", help="Build the website given the current working directory")
