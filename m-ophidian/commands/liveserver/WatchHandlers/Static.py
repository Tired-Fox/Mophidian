        ...
        try:
            if os.path.isfile(self.replace_prefix('static', 'site', event.src_path)):
                ...
                try:
                    ...
                    print(f"Deleted directory {self.replace_prefix('static', 'site', event.src_path)}")
                except: pass
    ...
    def on_moved(self, event: FileMovedEvent | DirMovedEvent):
        ...
        try:
            if not event.is_directory:
                ...
                print(f"Moved file {self.replace_prefix('static', 'site', event.src_path)} to {self.replace_prefix('static', 'site', event.dest_path)}")
            else:
                try:
                    print(
                        shutil.rmtree(
                ...
                print(f"Moved directory {self.replace_prefix('static', 'site', event.src_path)} to {self.replace_prefix('static', 'site', event.dest_path)}")
        except Exception as e: pass